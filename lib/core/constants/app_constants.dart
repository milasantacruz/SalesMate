...
class AppConstants {
  ...
  // IMPORTANTE: En Android, useCorsProxy debe ser false porque no puede acceder a localhost
  static const bool useCorsProxy = false; // Usar servidor directo en móvil
